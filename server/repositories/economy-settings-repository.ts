...
import {
  buildEconomySettingsSummary,
  defaultCampaignAlertChannels,
...
type EconomySettingsRow = QueryResultRow & {
  ...
  campaign_alert_channels: Record<string, unknown> | null;
...
export async function updateActiveEconomySettings({
  ...
  await runQuery(
    ...
    [
      ...
      JSON.stringify(next.campaignAlertChannels),
