...
INSERT INTO quest_definitions (
  ...
  (
    ...
    FALSE,
    TRUE,
    '{"track":"starter","targetUrl":"https://example.com/create-account","unlockRules":{"all":[]},"rewardConfig":{"xp":{"base":30,"premiumMultiplierEligible":true},"tokenEffect":"none"}}'::jsonb
  ),
  (
    ...
    FALSE,
    TRUE,
    '{"track":"wallet","targetUrl":"https://example.com/connect-xportal-wallet","unlockRules":{"all":[]},"rewardConfig":{"xp":{"base":35,"premiumMultiplierEligible":true},"tokenEffect":"eligibility_progress","tokenEligibility":{"progressPoints":12}}}'::jsonb
  ),
  (
    ...
    FALSE,
    TRUE,
    '{"track":"starter","unlockRules":{"all":[{"type":"min_level","value":2}]},"submissionGuidance":{"evidence":["first calorie conversion screenshot"]},"rewardConfig":{"xp":{"base":45,"premiumMultiplierEligible":true},"tokenEffect":"eligibility_progress","tokenEligibility":{"progressPoints":12}},"challengeConfig":{"firstConversion":true}}'::jsonb
  ),
  (
