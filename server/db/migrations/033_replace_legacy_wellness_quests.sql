...
SET
  ...
  is_active = TRUE,
  metadata = '{"track":"daily","targetUrl":"https://PENDING-DEV-INPUT.emorya.com/emoryan-adventure","_urlNote":"PENDING: Need Emorya app deep link to the Emoryan Adventure game.","unlockRules":{"all":[]},"rewardConfig":{"xp":{"base":30,"premiumMultiplierEligible":true},"tokenEffect":"none"}}'::jsonb,
  updated_at = NOW()
